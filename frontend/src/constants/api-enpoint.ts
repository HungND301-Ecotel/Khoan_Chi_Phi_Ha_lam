export const API = {
	CATALOG: {
		...
		PARAMETER: {
			...
			TRANSPORT_DISTANCE: {
				LIST: '/v1/catalog/hauldistance',
				CREATE: '/v1/catalog/hauldistance',
				UPDATE: '/v1/catalog/hauldistance',
				DELETES: '/v1/catalog/hauldistance',
				DELETE: (id: string) => `/v1/catalog/hauldistance/${id}`,
				DETAIL: (id: string) => `/v1/catalog/hauldistance/${id}`,
				IMPORT: '/v1/catalog/hauldistance/import',
				EXPORT: '/v1/catalog/hauldistance/export',
			},
		},
		TRANSPORT_LOCATION: {
			LIST: '/v1/catalog/transportlocation',
			CREATE: '/v1/catalog/transportlocation',
			UPDATE: '/v1/catalog/transportlocation',
			DELETES: '/v1/catalog/transportlocation',
			DELETE: (id: string) => `/v1/catalog/transportlocation/${id}`,
			DETAIL: (id: string) => `/v1/catalog/transportlocation/${id}`,
			IMPORT: '/v1/catalog/transportlocation/import',
			EXPORT: '/v1/catalog/transportlocation/export',
		},
		ADJUSTMENT: {
			FACTOR: {
		...
		CARGO_TYPE: {
			LIST: '/v1/catalog/cargotype',
			CREATE: '/v1/catalog/cargotype',
			UPDATE: '/v1/catalog/cargotype',
			DELETES: '/v1/catalog/cargotype',
			DELETE: (id: string) => `/v1/catalog/cargotype/${id}`,
			DETAIL: (id: string) => `/v1/catalog/cargotype/${id}`,
			IMPORT: '/v1/catalog/cargotype/import',
			EXPORT: '/v1/catalog/cargotype/export',
		},
	},
	SYSTEM: {
		FIXED_KEY: {
	...
	PRICING: {
		...
		MOTORIZED_TRANSPORT: {
			ALL: {
				LIST: '/v1/pricing/MechanizedTransportUnitPrice',
				EXPORT: '/v1/pricing/MechanizedTransportUnitPrice/export',
				IMPORT: '/v1/pricing/MechanizedTransportUnitPrice/import',
			},
			SCANIA: {
				LIST: '/v1/pricing/ScaniaTruckUnitPrice',
				CREATE: '/v1/pricing/ScaniaTruckUnitPrice',
				UPDATE: '/v1/pricing/ScaniaTruckUnitPrice',
				DELETES: '/v1/pricing/ScaniaTruckUnitPrice',
				DELETE: (id: string) => `/v1/pricing/ScaniaTruckUnitPrice/${id}`,
				DETAIL: (id: string) => `/v1/pricing/ScaniaTruckUnitPrice/${id}`,
				IMPORT: '/v1/pricing/ScaniaTruckUnitPrice/import',
				EXPORT: '/v1/pricing/ScaniaTruckUnitPrice/export',
			},
			VACUUM_TRUCK: {
				LIST: '/v1/pricing/WasteSuctionTruckUnitPrice',
				CREATE: '/v1/pricing/WasteSuctionTruckUnitPrice',
				UPDATE: '/v1/pricing/WasteSuctionTruckUnitPrice',
				DELETES: '/v1/pricing/WasteSuctionTruckUnitPrice',
				DELETE: (id: string) => `/v1/pricing/WasteSuctionTruckUnitPrice/${id}`,
				DETAIL: (id: string) => `/v1/pricing/WasteSuctionTruckUnitPrice/${id}`,
				IMPORT: '/v1/pricing/WasteSuctionTruckUnitPrice/import',
				EXPORT: '/v1/pricing/WasteSuctionTruckUnitPrice/export',
			},
			SERVICE_CRANE: {
				LIST: '/v1/pricing/ServiceAndCraneVehicleUnitPrice',
				CREATE: '/v1/pricing/ServiceAndCraneVehicleUnitPrice',
				UPDATE: '/v1/pricing/ServiceAndCraneVehicleUnitPrice',
				DELETES: '/v1/pricing/ServiceAndCraneVehicleUnitPrice',
				DELETE: (id: string) => `/v1/pricing/ServiceAndCraneVehicleUnitPrice/${id}`,
				DETAIL: (id: string) => `/v1/pricing/ServiceAndCraneVehicleUnitPrice/${id}`,
				IMPORT: '/v1/pricing/ServiceAndCraneVehicleUnitPrice/import',
				EXPORT: '/v1/pricing/ServiceAndCraneVehicleUnitPrice/export',
			},
			EXCAVATOR_DOZER: {
				LIST: '/v1/pricing/ExcavatorAndBulldozerUnitPrice',
				CREATE: '/v1/pricing/ExcavatorAndBulldozerUnitPrice',
				UPDATE: '/v1/pricing/ExcavatorAndBulldozerUnitPrice',
				DELETES: '/v1/pricing/ExcavatorAndBulldozerUnitPrice',
				DELETE: (id: string) => `/v1/pricing/ExcavatorAndBulldozerUnitPrice/${id}`,
				DETAIL: (id: string) => `/v1/pricing/ExcavatorAndBulldozerUnitPrice/${id}`,
				IMPORT: '/v1/pricing/ExcavatorAndBulldozerUnitPrice/import',
				EXPORT: '/v1/pricing/ExcavatorAndBulldozerUnitPrice/export',
			},
			LOW_VALUE_SUPPLY_ELECTRICITY: {
				LIST: '/v1/pricing/MechanizedTransportOverheadUnitPrice',
				CREATE: '/v1/pricing/MechanizedTransportOverheadUnitPrice',
				UPDATE: '/v1/pricing/MechanizedTransportOverheadUnitPrice',
				DELETES: '/v1/pricing/MechanizedTransportOverheadUnitPrice',
				DELETE: (id: string) => `/v1/pricing/MechanizedTransportOverheadUnitPrice/${id}`,
				DETAIL: (id: string) => `/v1/pricing/MechanizedTransportOverheadUnitPrice/${id}`,
				IMPORT: '/v1/pricing/MechanizedTransportOverheadUnitPrice/import',
				EXPORT: '/v1/pricing/MechanizedTransportOverheadUnitPrice/export',
			},
		},
	},
