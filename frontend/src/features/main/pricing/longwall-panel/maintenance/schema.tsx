...
export const longwallPanelFormSchema = z.object({
	type: z.number(),
	startMonth: z.iso
		.date({
...
export type LongwallPanelFormSchema = z.infer<typeof longwallPanelFormSchema>;

export const LONGWALL_PANEL_FORM_DEFAULT: LongwallPanelFormSchema = {
	type: 2,
	startMonth: '',
	endMonth: '',
	equipmentIds: [],
