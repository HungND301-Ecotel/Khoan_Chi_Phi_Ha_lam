...
import { MAIN_PRICING_MATERIAL_COLUMNS } from '@/features/main/pricing/trimming/material/columns';
...
export function MainPricingTrimmingMaterialPage() {
	...
	const handleImport = async (
		...
		try {
			const result = await api.import(API.PRICING.MATERIAL.TRIMMING.IMPORT, file);
