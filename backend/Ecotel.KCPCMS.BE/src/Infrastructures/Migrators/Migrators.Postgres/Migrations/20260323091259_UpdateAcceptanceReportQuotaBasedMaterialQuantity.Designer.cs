...
namespace Migrators.PostgreSQL.Migrations
{
    ...
    [Migration("20260323091259_UpdateAcceptanceReportQuotaBasedMaterialQuantity")]
    partial class UpdateAcceptanceReportQuotaBasedMaterialQuantity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Index.NormFactor", b =>
                {
                    ...
                    b.Property<Guid?>("ReferenceNormFactorId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReferenceNormFactorId");
            ...
            modelBuilder.Entity("Domain.Entities.Index.NormFactor", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Index.NormFactor", "ReferenceNormFactor")
                        .WithMany("ChildNormFactors")
                        .HasForeignKey("ReferenceNormFactorId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ReferenceNormFactor");
