...
namespace Migrators.PostgreSQL.Migrations
{
    ...
    [Migration("20260806030512_AddMechanizedTransportModule")]
    partial class AddMechanizedTransportModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Index.TransportRoute", b =>
                {
                    ...
                    b.Property<bool>("IsSpecialLowVolume")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportOverheadUnitPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("ElectricityNorm")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPriceDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.TransportUnitPrice", b =>
                {
                    ...
                    b.Property<bool>("IsLowVolumeCase")
                        .HasColumnType("boolean");
                    ...
                    b.Property<decimal?>("MaterialFuelUnitPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.ToTable("TransportUnitPrice", "Pricing", t =>
                        {
                            t.HasCheckConstraint("CK_TransportUnitPrice_AtLeastOnePrice", "(\"MaterialFuelUnitPrice\" IS NOT NULL OR \"PowerUnitPrice\" IS NOT NULL OR \"MaintenanceUnitPrice\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Production.LongTermAnchorSeedItemLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("LongTermAnchorSeedItemId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AcceptanceReportId", "PeriodStartMonth")
                        .HasFilter("\"DeletedOn\" IS NULL");

                    b.HasIndex("LongTermAnchorSeedItemId", "AcceptanceReportId")
                        .IsUnique()
                        .HasFilter("\"DeletedOn\" IS NULL");

                    b.ToTable("LongTermAnchorSeedItemLog", "Production");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.ExcavatorAndBulldozerUnitPrice", b =>
                {
                    b.HasBaseType("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice");

                    b.HasDiscriminator().HasValue(4);
                });

            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.ScaniaTruckUnitPrice", b =>
                {
                    b.HasBaseType("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice");
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.ServiceAndCraneVehicleUnitPrice", b =>
                {
                    b.HasBaseType("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice");
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.WasteSuctionTruckUnitPrice", b =>
                {
                    b.HasBaseType("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice");
            ...
            modelBuilder.Entity("Domain.Entities.Index.TransportRoute", b =>
                {
                    b.HasOne("Domain.Entities.Index.Code", "Code")
                        .WithOne("TransportRoute")
                        .HasForeignKey("Domain.Entities.Index.TransportRoute", "CodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Index.Code", "Code")
                        .WithOne("MechanizedTransportUnitPrice")
                        .HasForeignKey("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice", "CodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPriceDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Pricing.MechanizedTransport.MechanizedTransportUnitPrice", "MechanizedTransportUnitPrice")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.TransportUnitPrice", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Index.Product", null)
                        .WithMany("TransportUnitPrices")
                        .HasForeignKey("ProductId");
            ...
            modelBuilder.Entity("Domain.Entities.Production.LongTermAnchorSeedItemLog", b =>
                {
                    b.HasOne("Domain.Entities.Production.AcceptanceReport", "AcceptanceReport")
                        .WithMany("LongTermAnchorSeedItemLogs")
                        .HasForeignKey("AcceptanceReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Production.LongTermAnchorSeedItem", "LongTermAnchorSeedItem")
                        .WithMany("Logs")
                        .HasForeignKey("LongTermAnchorSeedItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AcceptanceReport");

                    b.Navigation("LongTermAnchorSeedItem");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Index.Product", b =>
                {
                    ...
                    b.Navigation("TransportUnitPrices");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Production.AcceptanceReport", b =>
                {
                    ...
                    b.Navigation("LongTermAnchorSeedItemLogs");
                });
