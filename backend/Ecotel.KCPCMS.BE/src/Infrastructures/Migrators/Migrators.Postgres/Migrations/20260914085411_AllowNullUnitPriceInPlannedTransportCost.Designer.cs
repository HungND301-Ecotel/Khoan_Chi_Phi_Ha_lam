...
namespace Migrators.PostgreSQL.Migrations
{
    ...
    [Migration("20260914085411_AllowNullUnitPriceInPlannedTransportCost")]
    partial class AllowNullUnitPriceInPlannedTransportCost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransportUnitPrice.ScaniaTruckUnitPriceReceivingLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ScaniaTruckUnitPriceId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TransportLocationId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("ScaniaTruckUnitPriceId");

                    b.HasIndex("TransportLocationId");

                    b.ToTable("ScaniaTruckUnitPriceReceivingLocations", "Pricing");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.PlannedTransportCost", b =>
                {
                    ...
                    b.ToTable("PlannedTransportCost", "Pricing", t =>
                        {
                            t.HasCheckConstraint("CK_PlannedTransportCost_AtMostOneUnitPriceReference", "(\"TransportUnitPriceId\" IS NULL OR \"MechanizedTransportUnitPriceDetailId\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransportUnitPrice.ScaniaTruckUnitPriceReceivingLocation", b =>
                {
                    b.HasOne("Domain.Entities.Pricing.MechanizedTransportUnitPrice.ScaniaTruckUnitPrice", "ScaniaTruckUnitPrice")
                        .WithMany("ReceivingLocations")
                        .HasForeignKey("ScaniaTruckUnitPriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Index.TransportLocation", "TransportLocation")
                        .WithMany()
                        .HasForeignKey("TransportLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ScaniaTruckUnitPrice");
            ...
            modelBuilder.Entity("Domain.Entities.Pricing.MechanizedTransportUnitPrice.ScaniaTruckUnitPrice", b =>
                {
                    b.Navigation("ReceivingLocations");
                });
