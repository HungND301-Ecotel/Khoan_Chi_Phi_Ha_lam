...
public record DeleteLongwallMaterialUnitPriceCommand(DefaultIdType DeleteId) : IRequest<bool>;

public class DeleteLongwallMaterialUnitPriceCommandHandler(IUnitOfWork unitOfWork, ICacheService cacheService) : IRequestHandler<DeleteLongwallMaterialUnitPriceCommand, bool>
{
    ...
    public async Task<bool> Handle(DeleteLongwallMaterialUnitPriceCommand request, CancellationToken cancellationToken)
    {
