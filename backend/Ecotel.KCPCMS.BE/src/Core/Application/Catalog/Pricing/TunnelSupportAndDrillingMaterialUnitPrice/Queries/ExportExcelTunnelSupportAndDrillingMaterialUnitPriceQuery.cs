...
public record ExportExcelTunnelSupportAndDrillingMaterialUnitPriceQuery() : IRequest<byte[]>;

public class ExportExcelTunnelSupportAndDrillingMaterialUnitPriceQueryHandler(IUnitOfWork unitOfWork) : IRequestHandler<ExportExcelTunnelSupportAndDrillingMaterialUnitPriceQuery, byte[]>
{
    ...
    public async Task<byte[]> Handle(ExportExcelTunnelSupportAndDrillingMaterialUnitPriceQuery request, CancellationToken cancellationToken)
    {
        ...
        var technologies = await _technologyRepository.GetAllAsync(selector: t => t.Value, disableTracking: true);
    ...
    private static Dictionary<string, double> BuildCostMap(TunnelSupportAndDrillingMaterialUnitPrice entity)
    {
    ...
    private static string GetPassportDisplayName(TunnelSupportAndDrillingMaterialUnitPrice data)
    {
