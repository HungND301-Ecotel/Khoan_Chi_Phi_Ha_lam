...
public record DeleteTunnelSupportAndDrillingMaterialUnitPriceListCommand(IList<DefaultIdType> DeleteIds) : IRequest<bool>;

public class DeleteTunnelSupportAndDrillingMaterialUnitPriceListCommandHandler(IUnitOfWork unitOfWork, ICacheService cacheService)
    : IRequestHandler<DeleteTunnelSupportAndDrillingMaterialUnitPriceListCommand, bool>
{
    ...
    public async Task<bool> Handle(DeleteTunnelSupportAndDrillingMaterialUnitPriceListCommand request, CancellationToken cancellationToken)
    {
