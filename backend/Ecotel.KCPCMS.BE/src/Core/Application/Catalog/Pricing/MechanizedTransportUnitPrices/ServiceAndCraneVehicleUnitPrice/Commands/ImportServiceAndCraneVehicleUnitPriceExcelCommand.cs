...
public record ImportServiceAndCraneVehicleUnitPriceExcelCommand(IFormFile File) : IRequest<bool>;

public class ImportServiceAndCraneVehicleUnitPriceExcelCommandHandler(
    IExcelService excelService,
    IUnitOfWork unitOfWork) : IRequestHandler<ImportServiceAndCraneVehicleUnitPriceExcelCommand, bool>
{
    ...
    public async Task<bool> Handle(ImportServiceAndCraneVehicleUnitPriceExcelCommand request, CancellationToken cancellationToken)
    {
        ...
        List<ServiceAndCraneVehicleUnitPriceExcelDto> dtos = excelService.ImportFromExcel<ServiceAndCraneVehicleUnitPriceExcelDto>(stream) ?? [];
        ...
        var deleteList = new List<Domain.Entities.Pricing.MechanizedTransportUnitPrice.ServiceAndCraneVehicleUnitPrice>();
        var updateList = new List<Domain.Entities.Pricing.MechanizedTransportUnitPrice.ServiceAndCraneVehicleUnitPrice>();
        var addList = new List<Domain.Entities.Pricing.MechanizedTransportUnitPrice.ServiceAndCraneVehicleUnitPrice>();
        ...
        foreach (var group in groups)
        {
            ...
            else
            {
                ...
                addList.Add(Domain.Entities.Pricing.MechanizedTransportUnitPrice.ServiceAndCraneVehicleUnitPrice.Create(
