...
public class TunnelSupportAndDrillingMaterialUnitPrice : MaterialUnitPrice
{
    ...
    public static TunnelSupportAndDrillingMaterialUnitPrice Create(
        string code,
        Guid processId,
        Guid passportId,
        Guid hardnessId,
        ...
        IList<MaterialUnitPriceAssignmentCode> costs)
    {
        ...
        var materialUnitPrice = new TunnelSupportAndDrillingMaterialUnitPrice
        {
