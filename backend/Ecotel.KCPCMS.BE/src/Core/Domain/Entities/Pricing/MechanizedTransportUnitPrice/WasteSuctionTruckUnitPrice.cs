...
public sealed class WasteSuctionTruckUnitPrice : MechanizedTransportUnitPrice
{
    public static WasteSuctionTruckUnitPrice Create(
        ...
        IEnumerable<MechanizedTransportUnitPriceDetailInput> details)
    {
        ...
        var entity = new WasteSuctionTruckUnitPrice();
