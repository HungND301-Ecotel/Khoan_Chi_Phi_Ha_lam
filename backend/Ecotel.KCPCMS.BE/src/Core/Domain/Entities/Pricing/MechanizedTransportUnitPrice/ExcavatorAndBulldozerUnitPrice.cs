...
public sealed class ExcavatorAndBulldozerUnitPrice : MechanizedTransportUnitPrice
{
    public static ExcavatorAndBulldozerUnitPrice Create(
        ...
        IEnumerable<MechanizedTransportUnitPriceDetailInput> details)
    {
        ...
        var entity = new ExcavatorAndBulldozerUnitPrice();
